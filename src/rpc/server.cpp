...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* K9S features */
        {"belle", "listmasternodes", &listmasternodes, true },
        {"belle", "getmasternodecount", &getmasternodecount, true },
        {"belle", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"belle", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"belle", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"belle", "masternodecurrent", &masternodecurrent, true },
        {"belle", "startmasternode", &startmasternode, true },
        {"belle", "createmasternodekey", &createmasternodekey, true },
        {"belle", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"belle", "listmasternodeconf", &listmasternodeconf, true },
        {"belle", "getmasternodestatus", &getmasternodestatus, true },
        {"belle", "getmasternodewinners", &getmasternodewinners, true },
        {"belle", "getmasternodescores", &getmasternodescores, true },
        {"belle", "preparebudget", &preparebudget, true },
        {"belle", "submitbudget", &submitbudget, true },
        {"belle", "mnbudgetvote", &mnbudgetvote, true },
        {"belle", "getbudgetvotes", &getbudgetvotes, true },
        {"belle", "getnextsuperblock", &getnextsuperblock, true },
        {"belle", "getbudgetprojection", &getbudgetprojection, true },
        {"belle", "getbudgetinfo", &getbudgetinfo, true },
        {"belle", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"belle", "mnfinalbudget", &mnfinalbudget, true },
        {"belle", "checkbudgets", &checkbudgets, true },
        {"belle", "mnsync", &mnsync, true },
        {"belle", "spork", &spork, true },
...
{
    return "> belle-cli " + methodname + " " + args + "\n";
}
