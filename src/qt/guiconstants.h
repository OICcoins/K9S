...
/* Belle GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Belle"
#define QAPP_ORG_DOMAIN "belle.org"
#define QAPP_APP_NAME_DEFAULT "Belle-Qt"
#define QAPP_APP_NAME_TESTNET "Belle-Qt-testnet"
