...
/** Utility functions used by the Belle Qt UI.
 */
namespace GUIUtil
{
...
// Render K9S addresses in monospace font
...
// Parse "belle:" URI into recipient object, return true on successful parsing
