...
bool CheckBlockSignature(const CBlock& block, const bool enableP2PKH)
{
    ...
    /** Each block is signed by the private key of the input that is staked. This can be either zK9S or normal UTXO
     *  zK9S: Each zK9S has a keypair associated with it. The serial number is a hash of the public key.
