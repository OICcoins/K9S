...
{
    const char* pszTimestamp = "Launching K9S For All DogKind";
...
public:
    CMainParams()
    {
        ...
        consensus.nStakeMinAge = 5 * 60 * 60; // Belle - 5 hours
        consensus.nStakeMinDepth = 100;
        consensus.nStakeMinDepthV2 = 600;
        consensus.nTargetTimespan = 20 * 60;  // Belle - every 20mins
        consensus.nTargetTimespanV2 = 25 * 60;  // Belle - every 25mins
        consensus.nTargetSpacing = 1 * 79; // Belle - 79 secs
        consensus.nTimeSlotLength = 15;

        // spork keys
        consensus.strSporkPubKey = "9b6e5c62d424b9f5878ee7aff68e9aa84d10821a33e99de27fed2d77f57247954";
        ...
        vSeeds.push_back(CDNSSeedData("seeder", "seeder.belle.net"));
	    vSeeds.push_back(CDNSSeedData("seed1", "seed1.belle.net"));
        vSeeds.push_back(CDNSSeedData("seed2", "seed2.belle.net"));
        vSeeds.push_back(CDNSSeedData("seed3", "seed3.belle.net"));
        vSeeds.push_back(CDNSSeedData("seed4", "seed4.belle.net"));
	    vSeeds.push_back(CDNSSeedData("seed5", "seed5.belle.net"));
	    vSeeds.push_back(CDNSSeedData("seed6", "seed6.belle.net"));
	    vSeeds.push_back(CDNSSeedData("seed7", "seed7.belle.net"));
	    vSeeds.push_back(CDNSSeedData("seed8", "seed8.belle.net"));
...
public:
    CTestNetParams()
    {
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // belle starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        ...
        // spork keys
        consensus.strSporkPubKey = "049137799e0a1b99f14bfccd350ad2904cd36d6d6597b50dbf35dd2e972ab5e233e3f4ba756990735e8e2a7e255cd82fd62c76d795ab596346ea62aaba79e8f111";
        consensus.strSporkPubKeyOld = "";
        consensus.nTime_EnforceNewSporkKey = 0;
        consensus.nTime_RejectOldSporkKey = 0;
        ...
        vSeeds.push_back(CDNSSeedData("tseeder", "tseeder.belle.net", true));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet belle addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet belle script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet belle BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet belle BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet belle BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        */
        consensus.strSporkPubKey = "046d427a68dd144226a8a17b20e2b4330e98e07bbfe1cbb75657b180b58a801dd8f86420d4bc781a3c6eb4ddec695dfee2b677f6b43c097610caa35a010cdff7ca";
        consensus.strSporkPubKeyOld = "";
        consensus.nTime_EnforceNewSporkKey = 0;
        consensus.nTime_RejectOldSporkKey = 0;
