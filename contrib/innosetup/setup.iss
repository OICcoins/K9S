...
#define MyAppName "Belle Core"
#define MyAppVersion "4.0.0.0"
#define MyAppPublisher "2021 Belle Core Developers"
#define MyAppURL "http://belle.net/"
#define MyAppExeName "belle-qt.exe"
#define MyAppExtraData "https://bellecoin.com/bootstraps/K9S/bootstrap.zip"
...
[Files]
Source: ".\package\belle-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Belle\Belle-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Belle\Belle-Qt,strDataDir|{userappdata}\Belle\}');
  Result := True;
end;
