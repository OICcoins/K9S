...
# Create zip file of binaries
    cp K9S/src/belled K9S/src/belle-cli K9S/src/belle-tx K9S/src/qt/belle-qt K9S/Belle-Core.dmg .
    zip K9S-MacOS.zip belled belle-cli belle-tx belle-qt Belle-Core.dmg
    rm -f belled belle-cli belle-tx belle-qt Belle-Core.dmg
