...
"""Verify that starting belle with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start belle with -? for help text")
        ...
        self.log.info("Start belle with -version for version information")
