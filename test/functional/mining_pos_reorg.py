...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv, expected_zpiv):
        ...
        # verify that nodes have the expected K9S and zK9S supply
        for node in g_info:
            assert_equal(node['moneysupply'], DecimalAmt(expected_piv))
            for denom in node['zK9Ssupply']:
                assert_equal(node['zK9Ssupply'][denom], DecimalAmt(expected_zpiv[denom]))
    ...
    def run_test(self):
        ...
        # Check K9S and zK9S supply at the beginning
        # ------------------------------------------
        # zK9S supply: 2 coins for each denomination
        ...
        # K9S supply: block rewards minus burned fees for minting
        ...
        # Verify that K9S and zK9S supplies were properly updated after the spends and reorgs
        self.log.info("Check K9S and zK9S supply...")
