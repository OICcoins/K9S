Contributing to Belle Core
============================

The Belle Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Belle Core project, and is not to be
confused with overall Belle Network Protocol consensus changes.

Whether a pull request is merged into Belle Core rests with the project merge
...
Patches that change Belle consensus rules are considerably more involved than
...
Where a patchset proposes to change the Belle consensus, it must have been
...
The project leader is the release manager for each Belle Core release.
