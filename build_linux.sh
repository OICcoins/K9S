...
# Create zip file of binaries
	cp K9S/src/belled K9S/src/belle-cli K9S/src/belle-tx K9S/src/qt/belle-qt .
	zip K9S-$(git describe --abbrev=0 --tags | sed s/v//)-Linux.zip belled belle-cli belle-tx belle-qt
	rm -f belled belle-cli belle-tx belle-qt
