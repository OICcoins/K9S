...
# Clone code from official Github repository
	rm -rf K9S
	git clone https://github.com/OICcoins/K9S.git
...
# Create zip file of binaries
	cp K9S/src/belled.exe K9S/src/belle-cli.exe K9S/src/belle-tx.exe K9S/src/qt/belle-qt.exe .
	zip K9S-Windows.zip belled.exe belle-cli.exe belle-tx.exe belle-qt.exe
	rm -f belled.exe belle-cli.exe belle-tx.exe belle-qt.exe
